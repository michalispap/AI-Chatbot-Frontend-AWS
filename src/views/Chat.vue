  ...
  <div class="chat-page">
    ...
    <div class="chat-messages" ref="messageContainer">
      ...
      >
        ...
        <template v-else>
          <span class="message-text" :class="{'animate-text': msg.id === lastMessageId}" v-html="renderMarkdown(msg.message)">
          </span>
        </template>
      </div>
    </div>
    ...
    <div class="toast-notification token-warning" v-if="showTokenWarning" :class="{ 'show': showTokenWarning }">
      <div class="toast-content">
        ...
        <span>Warning: Few tokens remaining ({{ Math.floor(availableTokens) }})</span>
      </div>
    </div>
  </div>
</template>
